...
@section('content')
    <div class="row w-70 p-2">
        <div class="col-md-6 mb-2">
            <a href="{{ route('pastes.index') }}" class="list-group-item list-group-item-action border mb-2 dark-border">
        ...
        @if(\Illuminate\Support\Facades\Auth::user())
            <div class="col-md-6 mb-2 mx-auto">
                <a href="{{ route('pastes.index') }}" class="list-group-item list-group-item-action border mb-2">
                    <h6 class="mb-0">Заголовок новости 5</h6>
                    <p class="mb-0 small">Автор: John Doe, Дата публикации: 12.02.2024</p>
                </a>
            </div>
